...
(function(){
  ...
  // Smooth continuous fill — reaches 100% right at explosion
  const totalTime=dur+400;
  fillBar.style.width='5%';
  setTimeout(()=>{
    fillBar.style.transition='width '+totalTime+'ms linear';
    fillBar.style.width='100%';
    fillBar.style.borderRadius='28px';
  },50);
